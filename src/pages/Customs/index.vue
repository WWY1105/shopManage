...
<div class="customs">
                ...
                <el-col :span="5">
                    <div class="grid-content bg-purple">
                        <el-form-item label="注册时间段">
                            <el-input v-model="formInline1.user" placeholder="注册时间段"></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="5">
                    <div class="grid-content bg-purple">
                        <el-form-item label="最后登录时间段">
                            <el-input v-model="formInline1.user" placeholder="最后登录时间段"></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="5">
                    <div class="grid-content bg-purple">
                        <el-form-item label="客户组">
                            <el-input v-model="formInline1.user" placeholder="客户组"></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
                    ...
                    <el-col :span="5">
                        <div class="grid-content bg-purple">
                            <el-form-item label="邀请人昵称">
                                <el-input v-model="formInline1.user" placeholder="邀请人昵称"></el-input>
                            </el-form-item>
                        </div>
                    </el-col>
                    <el-col :span="5">
                        <div class="grid-content bg-purple">
                            <el-form-item label="邀请人ID">
                                <el-input v-model="formInline1.user" placeholder="邀请人ID"></el-input>
                            </el-form-item>
                        </div>
                    </el-col>
                    <el-col :span="4">
    ...
    <div class="tableBox bgf">
        <el-table stripe :data="tableData" border style="width: 100%">
            <el-table-column prop="date" label="客户ID">
            </el-table-column>
            ...
            <el-table-column prop="address" label="邀请人ID"> </el-table-column>
            <el-table-column prop="address" label="邀请人昵称"> </el-table-column>
            ...
            <el-table-column prop="address" label="分销奖金"> </el-table-column>
            <el-table-column prop="address" label="分享佣金"> </el-table-column>
            <el-table-column prop="address" label="客户类型"> </el-table-column>
