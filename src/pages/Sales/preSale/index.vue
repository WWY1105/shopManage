...
<div class='preSale bgf'>
                ...
                <el-col :span="20">
                    <el-row  type="flex" justify="start" align="center">
                        ...
                        <el-col :span="14" class="flexStart" >
                            <p class="dangerTips">本模块仅包含预售商品，全部商品请至商品管理模块查看</p>
                        </el-col>
                    </el-row>
                </el-col>
    ...
    <div class="tableBox bgf">
        <el-table stripe :data="tableData" border style="width: 100%" fit>
            ...
            <el-table-column align="center" prop="address" label="预售价">
            </el-table-column>
            <el-table-column align="center" prop="address" label="预售定金">
            </el-table-column>
             <el-table-column align="center" prop="id" label="定金抵扣">
            </el-table-column>
            <el-table-column align="center" prop="name" label="预售截止">
            </el-table-column>
            <el-table-column align="center" prop="title" label="尾款时间">
            </el-table-column>
            <el-table-column align="center" prop="address" label="总库存">
            </el-table-column>
            <el-table-column align="center" prop="categoryId" label="预售库存">
            </el-table-column>
